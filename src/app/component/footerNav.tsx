...
export default function footerNav() {
  return (
    ...
    <div className='bg-emas w-3/4 mx-auto py-[2vh] md:py-[6vh] text-center rounded-md relative z-20'>
      ...
      <a href='https://api.whatsapp.com/send/?phone=%2B6285235622445&text&type=phone_number&app_absent=0'  className='linkButton text-[2.5vw] md:text-[1.5vw] py-[0.5vh] md:py-[2vh] px-[3vw] hover:bg-brown transition-colors rounded-[2.4vw] border-[0.2vw] text-white border-white '> Whatsapp Kami</a>
    </div>
    ...
    <div className='bg-cream w-full h-full pt-[13vh] md:pt-[30vh] pb-[6vh] px-[20vw] text-center mt-[-9vh] md:mt-[-23vh]'>
      ...
      <div className='flex mt-[3vh] md:mt-[6vh] gap-[1.6vw] justify-center'>
        ...
        <a href="https://api.whatsapp.com/send/?phone=%2B6285235622445&text&type=phone_number&app_absent=0">
